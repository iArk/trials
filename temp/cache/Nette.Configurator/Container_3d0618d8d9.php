<?php
// source: C:\xampp2\htdocs\netteRemaster\app/config/config.neon 
// source: C:\xampp2\htdocs\netteRemaster\app/config/config.local.neon 

class Container_3d0618d8d9 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [1 => ['application.1', 'application.5']],
			...
			'App\Presenters\PostpagePresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\PostpagePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp2\htdocs\netteRemaster\app',
			'wwwDir' => 'C:\xampp2\htdocs\netteRemaster\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp2\htdocs\netteRemaster\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\PostpagePresenter
	{
		$service = new App\Presenters\PostpagePresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp2\htdocs\netteRemaster\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp2\htdocs\netteRemaster\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp2\htdocs\netteRemaster\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=trials', 'root',
			null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_3d0618d8d9 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp2\htdocs\netteRemaster\app/../temp/cache/latte');
